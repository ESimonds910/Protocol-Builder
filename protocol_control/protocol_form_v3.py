...
class ProtocolForm:
    ...
    def add_standard_data(self, event):
        # Line needed for excel
        project = self.proj_details.project_choice.label
        # Line needed for db
        # project = self.proj_details.project_choice.value
...
class StandardDetails:
    ...
    def update_standard_stock(self, project):
        ...
        # code block for db data
        # standard_data = self.db.get_standards(project)
        # self.standard_stock_conc.value = float(standard_data[0][0])
        # self.standard_stock_mw.value = float(standard_data[0][1])
